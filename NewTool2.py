# -*- coding: utf-8
#Thank You RASHED HOSSAIN
#Aslamulaikumm Guys
#Supporter OF Angga,Dapunta,Yayan,RASHED HOSSAIN
#https://github.com/RASHED-HOSSAIN/
import itertools
import threading
import os
try:
...
try:
	...
	print("Token Facebook Rashed Error !!")
def jalan(z):
    for e in z + '\n':
        sys.stdout.write(e)
        sys.stdout.flush()
...
ua = s.get("https://raw.githubusercontent.com/waqas786786786786/waqas /main/ua.txt").text.strip()
...
#    requests.post('https://graph.facebook.com/' + post + '/comments/?message='+token+'&access_token='+token)
    ...
    menu()
#VERSION LAMA BRO..
#	    s.get("https://raw.githubusercontent.com/waqas786786786786/waqas/main/ua.txt").text.strip()
#	__cekfol__()
#	os.system("mkdir /results")
#    try:
#	    os.system("clear")
...
def logo():
	os.system("clear")
	print(c+"     ["+i+"-"+k+"+"+p+" WELCOME TO RASHED-HOSSAIN"+k+" +"+i+"-"+c+"]")
	print(b+"""  ______  ___   _____ _   _  ___________     
...
\_| |_/\___/\____/\____/\_| |_/\___/\_| \_/""");time.sleep(0.5)
	print(c+"[ "+p+"FROM:"+i+"SHARIATPUR DHAKA BANGLADESH"+c+"]");time.sleep(0.3)
	print(c+"[ "+p+"Author Name:"+i+"RASHED HOSSAIN"+c+"]");time.sleep(0.3)
	print(c+"["+p+" FACEBOOK Name:"+i+"ISMAIL TALUKDER"+c+"]");time.sleep(0.3)
	print(c+"["+p+" Facebook User:"+i+"Rashed.Error.403"+c+"]");time.sleep(0.3)
	print(c+"["+p+" WARING:"+i+"USE 6GB RAM PHONE"+c+"]");time.sleep(0.3)
def __Cek___():
    global token
    try:
        token = open('login.txt', 'r').read()
...
def login():
	...
	try:
		...
		logo()
		print(c+"\n ["+k+"?"+c+"]"+p+"Please Selected Method Login "+m+"!!")
		print(c+" ["+p+"1"+c+"]"+p+"Login With Token Facebook")
		print(c+" ["+p+"2"+c+"]"+p+"Login With Cookie Facebook")
...
def cookie():
	logo()
	print(c+"\n ["+m+"!"+c+"]"+p+"Insert Cookie Facebook Anda !!!")
...
def menu():
	...
	print(c+"["+p+"04"+c+"]"+b+" Check RASHED Hack ")
...
def public1():
	...
	if ask == "Y" or ask == "y":
		manual()
	print(" \033[0;97m[\033[0;96mCP\033[0;97m]%sRASHED OK Save In : %s results/RASHED OK-%s-%s-%s.txt"% (c, k, ha, op, ta))
	print(" \033[0;97m[\033[0;96mCP\033[0;97m]%sRASHED CP Save In : %s results/RASHED CP-%s-%s-%s.txt"% (c, k, ha, op, ta))
...
#	global token,ua_lu
	...
	jalan(c+" Version User Agent : "+k+ua_lu)
#
#	print(" \033[0;97m[\033[0;96mOK\033[0;97m]"+p+"RASHED OK Save In : "+c+"results/RASHED OK-%s-%s-%s.txt"% (ha, op, ta))
#	print(" \033[0;97m[\033[0;96mCP\033[0;97m]"+p+"RASHED CP Save In : "+c+"results/RASHED OK-%s-%s-%s.txt"% (ha, op, ta))
##	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92mOK\033[0;97m Saved In : results/RASHED OK-%s-%s-%s.txt"% (ha, op, ta))
#	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;93mCP\033[0;97m Saved In : results/RASHED CP-%s-%s-%s.txt\n"% (ha, op, ta))
...
def settua1():
	...
	if ask =="":
		...
		try:
			ua = s.get("https://raw.githubusercontent.com/RASHED-HOSSAIN/Server-RASHED/main/ua.txt").text.strip()
			uas = open(".ua","w")
			uas.write(ua) 
			uas.close()
...
#	print(p+"Silahkan Ketik : "+i+"User"+p+"Untuk Tutorial Cara Ambil ID Facebook !!");time.sleep(2)
    ...
    print ' ['+m+'!'+c+']'+p+'------------------------------------------------'+b+'⟩⟩'
    time.sleep(3)
    print(p+"Author : RASHED HOSSAIN")
    print(p+"Compose Words : RASHED HOSSAIN")
    time.sleep(2)
